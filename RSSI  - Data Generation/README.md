...
- **Dimensionality:** The environment is modelled as a two-dimensional Cartesian coordinate space, with positions represented as **(x, y)** coordinate pairs.
...
- **Limited device generation:** The number of devices in the network is constrained to a manageable range (e.g. **15–30**) to prevent excessive dataset size while still ensuring sufficient geometric coverage.
